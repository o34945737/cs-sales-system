                ...
                <section class="app-table-shell overflow-hidden">
                    <div class="grid gap-4 border-b border-[var(--app-border)] bg-[linear-gradient(135deg,_#eef4ff_0%,_#f8fbff_100%)] px-5 py-4 text-[var(--app-ink)] lg:grid-cols-[1.2fr,0.8fr]">
                        <div>
                            ...
                            <h1 class="mt-1 text-xl font-black tracking-tight">Reason Late Response Directory</h1>
                            <p class="mt-1 text-xs font-medium text-slate-500">
                                Kelola daftar reason late response untuk sinkronisasi pelaporan operasional.
                            </p>
                        </div>
                            ...
                            <table class="min-w-full divide-y divide-slate-100 text-[13px]">
                                <thead class="bg-slate-50/50">
                                    <tr class="text-left text-[10px] font-black uppercase tracking-widest text-slate-400">
                                        <th class="px-4 py-3">Reason Late Response</th>
            ...
            <DialogContent class="max-w-xl overflow-hidden rounded-[28px] border-0 p-0 shadow-[0_30px_80px_rgba(15,23,42,0.25)]">
                <div class="bg-[#EEF2FF] px-7 py-8">
                    <DialogHeader>
                        ...
                        <DialogDescription class="mt-2 text-base font-medium text-slate-500">Masukkan alasan keterlambatan respon baru untuk akurasi laporan SLA.</DialogDescription>
                    </DialogHeader>
                </div>
                ...
                <form class="space-y-6 bg-white px-7 py-7" @submit.prevent="submitCreate">
                    <div class="space-y-4">
                        <div class="grid gap-2">
                            ...
                            <Input id="create-name" v-model="createForm.name" placeholder="Contoh: Need warehouse approval" class="h-12 rounded-xl border-slate-200 bg-slate-50/50 px-4 text-sm transition focus:bg-white" />
                        ...
                        <div class="flex items-center gap-3 rounded-2xl border border-slate-100 bg-slate-50/50 px-4 py-4 transition hover:bg-slate-50">
                            ...
                            <span class="text-sm font-semibold text-slate-600">Reason aktif dan siap dipakai di modul pelaporan</span>
                        </div>
                    </div>
            ...
            <DialogContent class="max-w-xl overflow-hidden rounded-[28px] border-0 p-0 shadow-[0_30px_80px_rgba(15,23,42,0.25)]">
                <div class="bg-slate-900 px-7 py-8">
                    <DialogHeader>
                        ...
                        <DialogDescription class="mt-2 text-base font-medium text-slate-400">Perbarui alasan keterlambatan agar data operasional tetap konsisten.</DialogDescription>
                    </DialogHeader>
                </div>
