        ...
        return array_merge(parent::share($request), [
            ...
            'auth' => [
                ...
                'can' => [
                    ...
                    'import_complaints' => $user?->can('import complaints') ?? false,
                    'export_complaints' => $user?->can('export complaints') ?? false,
                    'access_bad_reviews' => $user?->can('access bad reviews') ?? false,
                    'import_bad_reviews' => $user?->can('import bad reviews') ?? false,
                    'export_bad_reviews' => $user?->can('export bad reviews') ?? false,
